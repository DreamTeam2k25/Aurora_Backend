...
from core.aurora.views import CommentsViewSet, PostsViewSet, PostImageViewSet, ReactionsViewSet, RepliesViewSet, ReplieOfReplieViewSet, ObdusmanViewSet
...
aurora_router.register(r'ombdusman', ObdusmanViewSet)
